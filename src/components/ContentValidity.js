function ContentValidity() {
  ...
  return (
    <div className="d-flex align-items-center justify-content-between border-y pt-2 pb-2">
      <div className="d-flex align-items-center ">
        <div className="d-flex align-items-center mr-3 gap-5">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          <label>Last Updated - {todayDate}</label>
        </div>
